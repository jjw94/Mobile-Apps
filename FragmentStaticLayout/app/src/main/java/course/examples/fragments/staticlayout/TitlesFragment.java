...
public class TitlesFragment extends ListFragment {
	...
	// Callback interface that allows this Fragment
	// to notify the QuoteViewerActivity when
	...
	public void onListItemClick(ListView l, View v, int pos, long id) {
		...
		// Inform the QuoteViewerActivity that the item in
		// position pos has been selected
