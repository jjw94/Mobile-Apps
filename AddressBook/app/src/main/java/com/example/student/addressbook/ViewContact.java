...
public class ViewContact extends ActionBarActivity
{
   ...
   private CheckBox familyCheckBox; //displays contact's family
   ...
   private class LoadContactTask extends AsyncTask<Long, Object, Cursor> 
   {
      ...
      protected void onPostExecute(Cursor result)
      {
         ...
         int familyIndex = result.getColumnIndex("family");
         ...
         if(result.getInt(familyIndex) != 0){
      ...
      switch (item.getItemId()) // switch based on selected MenuItem's ID
      {
         case R.id.editItem:
            ...
            if(familyCheckBox.isChecked()){
               addEditContact.putExtra("family", 1);
            }
            else{
               addEditContact.putExtra("family", 0);
            }
